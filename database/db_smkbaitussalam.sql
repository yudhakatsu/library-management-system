...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 05 Jan 2025 pada 12.58
...
INSERT INTO `data_tamu` (`ID`, `Nama`, `Profesi`, `Status_Jabatan`) VALUES
(1, 'Dwi alya', 'Mahasiswa', 'Mahasiswa');

-- --------------------------------------------------------

--
-- Struktur dari tabel `inventaris_buku`
--
...
--
-- Dumping data untuk tabel `inventaris_buku`
--

INSERT INTO `inventaris_buku` (`ID`, `Sumber`, `Tanggal_Masuk`, `Pengarang`, `Judul_Buku`, `kategori`, `Penerbit`, `Tempat_Terbit`, `Tahun_Terbit`, `Jumlah`, `Penerima`, `gambar_sampul`) VALUES
...
--
-- Dumping data untuk tabel `riwayatpeminjaman`
--

INSERT INTO `riwayatpeminjaman` (`id`, `nis`, `nama`, `Judul_Buku`, `Tanggal_Pinjam`, `Tanggal_Kembali`, `Status`) VALUES
...
INSERT INTO `users` (`NIS`, `Password`, `Nama`, `Jenis_Kelamin`, `Program_Keahlian`, `Kelas`) VALUES
...
--
-- Indeks untuk tabel `inventaris_buku`
--
ALTER TABLE `inventaris_buku`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT untuk tabel `inventaris_buku`
--
ALTER TABLE `inventaris_buku`
