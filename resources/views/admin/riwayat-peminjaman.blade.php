...
<body class="bg-light">
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="{{route('admin.riwayat-peminjaman')}}" class="sub-active"><i class="fas fa-chevron-right"></i> Riwayat Peminjaman</a></li>
        ...
        <div class="row">
            ...
            <main>
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1 class="h3">Riwayat Peminjaman</h1>
                </div>

                <!-- Search -->
                <div class="search mb-3 d-flex align-items-center gap-2">
                    <div class="position-relative flex-grow-1">
                        <form action="{{ url('/admin/riwayat-peminjaman') }}" method="GET">
                            <input class="search-input form-control" type="text" name="query" placeholder="Cari berdasarkan NIS, Nama atau Status" value="{{ request('query') }}">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge 
                                        @if($item['Status'] == 'Terlambat') bg-danger 
                                        @elseif($item['Status'] == 'Selesai') bg-success 
                                        @elseif($item['Status'] == 'Sedang dipinjam') bg-warning 
                                        @endif">
                                        {{ $item['Status'] }}
                                    </span>
                                </td>
